...
export function FollowUpComposer({ dealId, draft }: FollowUpComposerProps) {
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle className="font-['Sora',sans-serif] flex items-center gap-2">
            Follow-up Draft
            <span className="font-mono text-[9px] font-bold uppercase tracking-wider bg-[hsl(var(--foreground))] text-[hsl(var(--background))] px-1.5 py-0.5 flex items-center gap-1" title="Generated by AI models configured in your Workspace Settings">
