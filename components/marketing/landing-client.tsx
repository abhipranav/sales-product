...
const faqs = [
  {
    ...
    answer: "Yes. Sync endpoints are incremental upsert workflows, not forced migrations.",
  },
  {
      ...
      <header className="sticky top-0 z-30 border-b-[2px] border-[hsl(var(--border))] bg-[hsl(var(--background))]/95 backdrop-blur-sm">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-2.5 md:px-8">
          ...
          <nav className="hidden items-center md:flex">
            ...
            <div className="ind-divider-v h-5 mx-4" />
            <Link href="/showcase" className="ind-label text-yellow-400 hover:text-yellow-400 transition-colors font-bold">
              Showcase
            </Link>
            <div className="ind-divider-v h-5 mx-4" />
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          <div className="ind-card relative">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link href="/showcase" className="ind-btn-outline border-yellow-400/50 text-yellow-400 bg-yellow-400/5 hover:bg-yellow-400 hover:text-black">
                VIEW PRODUCT TOUR →
              </Link>
